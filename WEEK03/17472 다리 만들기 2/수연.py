# 다리들 중 최솟값을 골라 더하는 부분이 막혀서 정답 참고했슴다
# bfs로 라벨링, 다리놓기 했고, MST 크루스칼로 다리 길이 최솟값 구했습니당
# 내가 생각하는 이 코드의 핵심 Key 💡
# -> 섬 라벨링 할 때 섬 좌표값을 key로 설정하면 현재 좌표만 알아도 어디 섬 위인지, 바다 위인지 알 수 있음
# 와,,,, 멋지네염
#   ㄴ2222222222
"""
